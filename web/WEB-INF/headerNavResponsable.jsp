...
<div class="row">
    <nav class="navbar navbar-dark bg-dark NavBar">
        <div class="col-lg-8">
            ...
            <a class="navbar-brand textSize" href="${pageContext.request.contextPath}/InscriptionPromo">Inscrire une pormotion</a>

            <a class="navbar-brand textSize" href="${pageContext.request.contextPath}/Result">Voir les résultats</a>
        </div>
